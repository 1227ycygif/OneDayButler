...
{
    public static csSoundManager manager { get; private set; }
    ...
    public bool destroyTempsOnScene = true;

    // 동적 생성한 오디오 객체 추적용
    private List<GameObject> sfxObjects = new();
    private List<GameObject> bgmObjects = new();
